...
void calculateMoneyForBoat(Boat &boat)
{
    ...
    cout << "Boat " << boat.boatNumber << " hired for " << hoursToHire << " hours. Total cost: $" << cost << "\n";
}

void findAvailableBoats(const vector<Boat> &boats, const string &currentTime)
{
...
void calculateTotalMoney(const vector<Boat> &boats)
{
